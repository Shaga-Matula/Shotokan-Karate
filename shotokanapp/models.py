...
class StudentLevelMod(models.Model):
    ...
    def __str__(self):
        return f"{self.kyu_level}"


class SenseiMod(models.Model):
    """
    This is the Sensei Mod
    """
    sensei_first_name = models.CharField(max_length=50, 
                                         verbose_name='Sensei Name')
    sensei_last_name = models.CharField(max_length=50, 
                                        verbose_name='Sensei Last Name')
    ...
    def __str__(self):
        return f"{self.sensei_first_name}"



class CustomUser(AbstractUser):
    """
    This is the Custom User Mod
    This sets the roles for access to pages
    """
    ...
    date_of_birth = models.DateField(verbose_name='Date of Birth', null=True,
                                     blank=True)
    contact_num = PhoneNumberField(verbose_name='Student Contact Number',
                                   blank=True, null=True)
    ...
    student_grade = models.ForeignKey(StudentLevelMod,
                                      on_delete=models.PROTECT, default=1,
                                      verbose_name='Kyu To Achieve')
    sensei = models.ForeignKey(SenseiMod, on_delete=models.PROTECT,
                               default=None, verbose_name='Sensei', null=True)
...
class Contact(models.Model):
    ...
    Here the form can be used to 
    reqrute new students
    """
    class Meta:
